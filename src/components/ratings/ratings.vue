    ...
    <div class="ratings_content">
      <div class="overview">
        <div class="overview_left">
          <h1 class="foodScore">{{seller.score}}</h1>
      ...
      <div class="ratings_wrapper">
        <ul>
          <li class="ratings_item" v-for="(ratingItem,index) in ratings" :key="index" v-show="needShow(ratingItem.rateType,ratingItem.text)">
            <div class="avatar">
...
export default {
    ...
    methods: {
        ...
        needShow(type, text) {
            ...
            if (this.selectType === ALL || this.selectType === type) { // 显示所有评论
                return true;
            } else {
                return false;
            }
